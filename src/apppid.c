...
void APPPID_Initialize ( void )
{
    ...
    apppidData.state = APPPID_STATE_INIT;
...
void APPPID_Tasks ( void )
{
    ...
    switch ( apppidData.state )
    {
        ...
        case APPPID_STATE_INIT: break; //It is in standby mode until a decision is made to use this task.
        case APPPID_STATE_SERVICE_TASKS:
        {
